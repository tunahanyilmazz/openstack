...
# Create a temporary file to store the part to be copied
TEMP_FILE="/tmp/sources_list_part"

# Write the specified part to the temporary file
cat <<EOL > $TEMP_FILE
...
# Copy the temporary file to /etc/apt/sources.list
sudo cp $TEMP_FILE /etc/apt/sources.list

# Clean up the temporary file
rm $TEMP_FILE

echo "The specified part has been copied to /etc/apt/sources.list"
